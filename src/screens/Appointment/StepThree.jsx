...
import {
  View, Text, TouchableOpacity, TextInput, StyleSheet, ScrollView, CheckBox, Linking
} from 'react-native';
...
const wellnessOptions = ['Sleep', 'Mood', 'Digestion', 'Focus', 'Fitness', 'Energy'];
    ...
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.checkboxRow}>
        ...
        <Text style={styles.checkboxText}>
          I understand that my information will be used in accordance with HIPAA privacy standards...
        </Text>
      </View>
...
const styles = StyleSheet.create({
  ...
  heading: { fontSize: 24, fontWeight: '700', textAlign: 'center', marginBottom: 6 },
  subText: { textAlign: 'center', fontSize: 16, color: '#1E1E1E', marginBottom: 6 },
  stepText: { textAlign: 'center', color: colors.primary, fontWeight: '600', marginBottom: 10 },
  ...
  sectionTitle: { fontSize: 14, fontWeight: '600', color: colors.primary, marginBottom: 10, textAlign: 'center' },
  label: { fontSize: 13, color: '#111827', marginBottom: 6, fontWeight: '600' },
  optionWrap: { flexDirection: 'row', flexWrap: 'wrap', gap: 2, marginBottom: 16 },
  optionBtn: {
    borderWidth: 1, borderColor: '#E5E7EB', borderRadius: 10, paddingVertical: 8, paddingHorizontal: 14,
  ...
  textArea: {
    ...
    textAlignVertical: 'top', marginBottom: 10, fontSize: 13,height: 110
  },
  checkboxRow: { flexDirection: 'row', alignItems: 'center', marginBottom: 8 },
  checkboxText: { flex: 1, marginLeft: 8, fontSize: 12, color: '#374151' },
  privacyLink: { color: colors.primary, fontSize: 12, textDecorationLine: 'underline', marginBottom: 10 },
